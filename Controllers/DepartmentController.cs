    ...
    public class DepartmentController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            BaseService.AddUserActive(currentUserID, IpAddress, 
                new MessageResults { Id = -1, message = "Xem chức năng", Tittle = "Quản lý phòng/ban" }, ConnectionString);
            return View();
        }
        ...
        public IEnumerable<Department> Get()
        {
            ...
            try
            {
                ...
                while (sqlDataReader.Read())
                {
                    ...
                    _result.DepartmentCodeName = sqlDataReader["DepartmentCodeName"].ToString();
        ...
        public MessageResults Add(Department department)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@Code", (department.Code == null ? DBNull.Value : (object)department.Code));
        ...
        [HttpPost]
        //[ValidateAntiForgeryToken]
        public MessageResults Edit(Department department)
        {
            MessageResults _result = new MessageResults();
            string ConnectionString = String.Format("{0}", Configuration.GetConnectionString("DefaultConnection"));
            SqlConnection sqlConnection = new SqlConnection(ConnectionString);
