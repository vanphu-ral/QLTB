...
{
    [Authorize]
    public class DeviceRepairImportantController : Controller
    {
        private readonly ILogger<DeviceRepairImportantController> _logger;
        private static readonly NLog.Logger _Nlog = NLog.LogManager.GetCurrentClassLogger();
        public IConfiguration Configuration { get; }
        public DeviceRepairImportantController(ILogger<DeviceRepairImportantController> logger, IConfiguration configuration)
        {
            _logger = logger;
